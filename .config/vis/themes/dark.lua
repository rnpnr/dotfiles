...
lexers.STYLE_KEYWORD = 'fore:default,bold'
lexers.STYLE_LABEL = 'fore:default,bold'
...
lexers.STYLE_TYPE = 'fore:default,bold'
...
lexers.STYLE_COLOR_COLUMN = 'back:#444440'
lexers.STYLE_SELECTION = 'back:#444440'
lexers.STYLE_STATUS = 'back:white,fore:black'
lexers.STYLE_STATUS_FOCUSED = 'back:white,fore:black,bold'
